...
import { attachmentTypeCaster } from "../arguments/attachment";
...
import { emojiTypeCaster } from "../arguments/emoji";
import {
  guildChannelSilentTypeCaster,
  guildChannelTypeCaster,
} from "../arguments/guildChannel";
import { hasteTypeCaster } from "../arguments/haste";
import { languageTypeCaster } from "../arguments/language";
import { listenerTypeCaster } from "../arguments/listener";
import {
  memberSilentTypeCaster,
  memberTypeCaster,
} from "../arguments/member";
import { memberRoleTypeCaster } from "../arguments/memberRole";
import { memberRoleChannelTypeCaster } from "../arguments/memberRoleChannel";
import { messageTypeCaster } from "../arguments/message";
import { moduleTypeCaster } from "../arguments/module";
import {
  previewSilentTypeCaster,
  previewTypeCaster,
} from "../arguments/preview";
import { roleSilentTypeCaster, roleTypeCaster } from "../arguments/role";
import {
  textChannelSilentTypeCaster,
  textChannelTypeCaster,
} from "../arguments/textChannel";
import { userSilentTypeCaster, userTypeCaster } from "../arguments/user";
import { userMemberTypeCaster } from "../arguments/userMember";
import { userMemberSnowflakeTypeCaster } from "../arguments/userMemberSnowflake";
...
export class Fire extends AkairoClient {
  ...
  // Private Utilities
  private readyWait: Promise<Fire> | undefined;
    ...
    this.commandHandler = new CommandHandler(this, {
      ...
      prefix: (message: FireMessage) => {
        ...
        return process.env.SPECIAL_PREFIX
          ...
          ? [
              ...prefixes,
              ...prefixes.map((prefix: string) => prefix + " "),
              "fire",
              "fire ",
            ]
          : ["$", "fire "];
